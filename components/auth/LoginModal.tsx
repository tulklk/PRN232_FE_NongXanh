                ...
                <div className="grid grid-cols-1 md:grid-cols-2">
                    <div className="p-8 md:p-10">
                            ...
                            <>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4 mb-4">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => setMode('otp')}
                                        className="text-[#0A923C] hover:underline text-sm block"
                                        disabled={loading}
                                    >
                                        Đăng nhập bằng OTP
                                    </button>
                                    ...
                                    <button 
                                        type="submit"
                                        className="w-full bg-[#0A923C] text-white py-3 px-6 rounded-lg font-semibold hover:bg-[#087a32] transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
                                        disabled={loading}
                                    >
                                ...
                                <div className="text-center mb-6">
                                    <p className="text-sm text-gray-600">
                                        ...
                                        <button type="button" className="text-[#0A923C] font-semibold hover:underline" disabled={loading}>Đăng ký</button>
                                    </p>
                        ...
                        <div className="flex gap-3 justify-center mb-4">
                            <button className="flex items-center justify-center gap-2 bg-[#1877F2] text-white py-3 px-6 rounded-lg font-semibold hover:bg-[#166fe5] transition-colors disabled:opacity-50" disabled={loading}>
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                                </svg>
                                FACEBOOK
                            </button>
                            <button className="flex items-center justify-center gap-2 bg-[#EA4335] text-white py-3 px-6 rounded-lg font-semibold hover:bg-[#d93325] transition-colors disabled:opacity-50" disabled={loading}>
                    ...
                    <div className="hidden md:flex bg-gradient-to-br from-green-50 via-white to-blue-50 items-center justify-center p-8">
                        <div className="text-center max-w-xs">
                            ...
                            <h3 className="text-2xl font-bold text-[#0A923C] mb-2">Foodmap</h3>
