...
export default function CategorySidebar({ activeCategory }: CategorySidebarProps) {
  ...
  const buildProductsHref = (overrides: Record<string, string | null | undefined>) => {
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-1.5">
          {featuredProviders.length > 0 ? (
            featuredProviders.map(({ provider, imageSrc }) => {
              ...
              return (
                <Link
                  ...
                  className={`block bg-white border rounded p-1.5 transition-colors hover:border-primary-green ${
                    isBrandActive ? 'border-primary-green ring-1 ring-primary-green/30' : 'border-gray-200'
                  }`}
                >
                  <img
