      ...
      <section className="max-w-[1400px] mx-auto px-8 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          ...
          <div className="space-y-3">
            <div className="bg-[#0A923C] text-white px-4 py-2 rounded-t-lg font-semibold">TIN NỔI BẬT</div>
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-1">
                <span className="bg-[#0A923C] text-white px-3 py-2 rounded font-mono font-bold text-lg">{formatTime(countdown.hours)}</span>
                <span className="text-[#0A923C] font-bold text-xl">:</span>
                <span className="bg-[#0A923C] text-white px-3 py-2 rounded font-mono font-bold text-lg">{formatTime(countdown.minutes)}</span>
                <span className="text-[#0A923C] font-bold text-xl">:</span>
                <span className="bg-[#0A923C] text-white px-3 py-2 rounded font-mono font-bold text-lg">{formatTime(countdown.seconds)}</span>
              </div>
